				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="input-group form-group">
							...
							<input type="password" name="passw" id="psw" class="form-control"
						...
						<div class="input-group form-group">
							...
							<input type="password" id="cpsw" class="form-control"
						...
						<div class="input-group form-group">
							...
							<div class="dropdown">
								<select id="mylist" name="secq" class="list">
									...
									<option value="What is your date of
										birth?(dd-mm-yyyy)">What is your date of
										birth?(dd-mm-yyyy)</option>
