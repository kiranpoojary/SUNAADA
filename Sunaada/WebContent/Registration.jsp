...
<style type="text/css">
	...
	body,html{ background-image: url('file:///F:/Sunada_proj_files/background2.jpg'); background-size:
	cover; background-repeat: no-repeat; height: 100%; font-family: 'Numans',
	sans-serif;
