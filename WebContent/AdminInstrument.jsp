...
<body>
	...
	<%
		...
		getInstrument.next();
		String pname = getInstrument.getString(2);
		String pdesc = getInstrument.getString(4);
		Double fare = getInstrument.getDouble(5);
		Integer qty = getInstrument.getInt(7);
		Integer off = getInstrument.getInt(10);
