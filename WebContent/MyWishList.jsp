                    ...
                    <tr>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h5 class="media-heading"> Category <a href="#"><%=instruInfo.getString(2) %></a></h5>
                                <span>Status: </span><span class="text-success"><strong><%=(instruInfo.getInt(6)!=0)?"Available":"No Stock"%></strong></span>
                            </div>
                        </div></td>
                        <td class="col-sm-1 col-md-1" style="text-align: center">
                        <input type="email" class="form-control" id="exampleInputEmail1" value="<%=instruInfo.getInt(6)%>" disabled>
                        </td>
                        <td class="col-sm-1 col-md-1 text-center"><strong>Rs.<%=instruInfo.getDouble(4)%></strong></td>
                        <td class="col-sm-1 col-md-1 text-center"><strong><%=instruInfo.getInt(9)%>%</strong></td>
